...
try {
  ...
  $p = new PushBullet('EO1f1ykNWSU7wCGafCs0NwwWfcrv19YC');
...
*/
  ...
  $p->pushNote('freeyland@gmail.com', 'Seb Hey3!', 'It works2!');

  // Push to device s2GBpJqaq9IY5nx a note with a title 'Hey!' and a body 'It works!'
  $p->pushNote('ujD4OkgbmBUsjz7O3P0Jl6 ', 'SEB Hey3!', 'It works for IOS only!');
    die;
