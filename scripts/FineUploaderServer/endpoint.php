...
$uploader->allowedExtensions = explode(',',$_POST["allowedextensions"]); // all files types allowed by default
...
if ($method == "POST") {
    ...
    if (isset($_GET["done"])) {
        $result = $uploader->combineChunks($_POST["folder"], $_POST["newfilename"]);
    }
    // Handles upload requests
    else {
        // Call handleUpload() with the name of the folder, relative to PHP's getcwd()
        $result = $uploader->handleUpload($_POST["folder"], $_POST["newfilename"]);
