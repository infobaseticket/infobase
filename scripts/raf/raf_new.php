    ...
    for ($i = 0; $i <$amount_of_RAFS; $i++) {  
        ...
        {  
            ...
            <colgroup>
                ...
                <col style='width: 150px'><!-- action by -->";
            ...
            <colgroup>";
                ...
                <thead>
                    <tr>    
                        <th style='font-size:9px' class='".$row_color."'>RAF ID</th>
                        <th style='font-size:9px' class='".$row_color."'>SITEID</th>
                        <th style='font-size:9px' class='".$row_color."'>TYPE</th>
                        <th style='font-size:9px' class='".$row_color."'>ACTION BY</th>";

                        if ($res1['OTHER_INP'][$i]!="NA"){
                         $$output_raf.="<th class='acquisition ".$row_color."'>OPS INPUT</th>";
                        }
                        if ($res1['RADIO_INP'][$i]!="NA"){
                        $$output_raf.="<th class='acquisition ".$row_color."'><a rel='tooltip' title='Input to be provided by BASE RF' class='tip'>RF INPUT</th>";
                        }
                        if ($res1['TXMN_INP'][$i]!="NA"){
                        $$output_raf.="<th class='acquisition ".$row_color."'><a rel='tooltip' title='Input to be provided by BASE Transmission' class='tip'>TX INPUT</th>";
                        }
                        if ($res1['ACQ_PARTNER'][$i]!="NA"){
                        $$output_raf.="<th class='acquisition ".$row_color."'><a rel='tooltip' title='Acquisition partner to be provided by SDM' class='tip'>SAC PARTNER</a></th>";
                        }
                        $$output_raf.="<th class='acquisition ".$row_color."'><a rel='tooltip' title='Provided by BASE Delivery' class='tip'>NET1 LINK</a></th>";
                        
                        if ($res1['COF_ACQ'][$i]!="NA"){
                        $$output_raf.="<th class='acquisition ".$row_color."'><a rel='tooltip' title='COF info for acquisition' class='tip'>COF ACQ</a></th>";
                        }
                        if ($PO_ACQ!="NA"){
                        $$output_raf.="<th class='acquisition ".$row_color."'><a rel='tooltip' title='PO info automatically imported from SAP. Contact Base delivery if problems' class='tip'>PO ACQ</a></th>";
                        }
                        if ($res1['PARTNER_INP'][$i]!="NA"){
                        $$output_raf.="<th class='acquisition ".$row_color."'>PARTNER INPUT</th>";                        
                        }
                        if ($res1['NET1_A304'][$i]!="NA"){
                        $$output_raf.="<th class='acquisition ".$row_color."'><a rel='tooltip' title='Best Candidate proposed to Base' class='tip'>A304 PARTNER</a></th>";
                        }
                        if ($res1['BCS_TX_INP'][$i]!="NA" or $res1['BCS_RF_INP'][$i]!="NA"){
                        $$output_raf.="<th class='acquisition ".$row_color."'><a rel='tooltip' title='Best Candidate Selection approval by Transmission and Radio' class='tip'>BCS RF & TXMN</a></th>";
                        }
                        if ($bcs_net1!="NA"){
                        $$output_raf.="<th class='acquisition ".$row_color."'><a rel='tooltip' title='Best Candidate Selected A15 toggled in NET1' class='tip'>BCS A15</a></th>";
                        }
                        if ($res1['NET1_LBP'][$i]!="NA"){
                        $$output_raf.="<th class='acquisition ".$row_color."'><a rel='tooltip' title='LEASE OK TO BUILD / BP OK TO BUILD UA709 / U405 - A105' class='tip'>LS&BP OK</a></th>";
                        }
                        if ($res1['PARTNER_ACQUIRED'][$i]!="NA"){
                        $$output_raf.="<th class='acquisition ".$row_color."'><a rel='tooltip' title='Raf acquisition completed' class='tip'>PARTN ACQ. UA711</a></th>";
                        }
                        if ($res1['TXMN_ACQUIRED'][$i]!="NA"){
                        $$output_raf.="<th class='acquisition ".$row_color."'h><a rel='tooltip' title='TXMN Acquisition approval' class='tip'>TX ACQ</a></th>";
                        }
                        if ($res1['NET1_ACQUIRED'][$i]!="NA"){
                        $$output_raf.="<th class='acquisition ".$row_color."'><a rel='tooltip' title='ACQUISITION COMPLETED' class='tip'>N1 ACQ. UA352</a></th>";
                        }
                        $$output_raf.="<th class='construction ".$row_color."'>RF FUND SITE</th>";
                        $$output_raf.="<th class='construction ".$row_color."'>CON PARTNER</th>";
                        $$output_raf.="<th class='construction ".$row_color."'><a rel='tooltip' title='SITE FUNDED (to update in NET1)' class='tip'>N1 FUNDING UA353</a></th>";
                        $$output_raf.="<th class='construction ".$row_color."'><a rel='tooltip' title='COF info for construction' class='tip'>COF CON</a></th>";
                        
                        $$output_raf.="<th class='construction ".$row_color."'><a rel='tooltip' title='PARTNER submit RF PACK' class='tip'>PARTNER RF PACK</th>
                        <th class='construction ".$row_color."'><a rel='tooltip' title='RAF PAC Complete (to update in NET1)' class='tip'>RF PAC >UA712</a></th>
                        <th class='construction ".$row_color."'>PO CON</th>
                        <th class='construction ".$row_color."'><a rel='tooltip' title='PARTNER validation request' class='tip'>PARTNER VAL. REQ.</th>
                        <th class='construction ".$row_color."'><a rel='tooltip' title='DELIVERY VALIDATION' class='tip'>DELIVERY VALIDATION</a></th>
                        <th class='construction ".$row_color."'>COMMERCIAL + PHASE</th>
                        <th class='construction ".$row_color."'>SAC - CON NET1</th>
                    </tr>
                    </thead>
                    <tbody
                <tr id='row_".$res1['RAFID'][$i]."' class='".$row_color."'>";
                ...
                <div class='btn-group'>
                  ...
                  <button type='button' class='btn btn-xs btn-default rafnav' data-action='print' data-id='".$res1['RAFID'][$i]."' data-site='".$res1['SITEID'][$i]."'><span class='glyphicon glyphicon-print'></span></button>";
                   if ($res1['NET1_LINK'][$i]!="NOT OK"){
                    $$output_raf2.="<button type='button' class='btn btn-xs btn-default rafnav' data-action='net1explorer' data-siteid='".$res1['SITEID'][$i]."' data-net1link='".$res1['NET1_LINK'][$i]."' title='OPEN corresponding NET1 info'><span class='glyphicon glyphicon-th-large'></span></button>";
                    }
                ...
                ".$BSDSINFO."<br>
                 ...
                 $$output_raf2.="<td>".$res1['SITEID'][$i]."</td>
                <td><b>".$type."</b></td>
                ...
                if ($status_special3!=""){
                    $$output_raf2.="<span class='conditional label label-info'>".$status_special3."</span>";
                }
                $$output_raf2.="</td>";
                ...
                $$output_raf.="<td class='".$NET1_LINK_class." ".$extra_class."'><span ".$gclass1." id='NET1_LINK-".$res1['RAFID'][$i]."' class='tabledata ".$NET1_LINK_select."' data-type='select' data-pk='".$res1['RAFID'][$i]."' data-siteid='".$res1['SITEID'][$i]."' data-original-title='Provide the cand or UPG nr'>".$NET1_LINK."</span> ".$NET1_LINK_info."</td>";
                ...
                if ($res1['BCS_TX_INP'][$i]!="NA" or $res1['BCS_RF_INP'][$i]!="NA"){
                    $$output_raf.="<td class='".$BCS_TXRF_class."'>RF: <span id='BCS_RF_INP-".$res1['RAFID'][$i]."' class='tabledata ".$BCS_RF_select."' data-type='select' data-pk='".$res1['RAFID'][$i]."'>".$res1['BCS_RF_INP'][$i]."</span> ".$BCS_RF_INP_info."<br>TX: <span id='BCS_TX_INP-".$res1['RAFID'][$i]."' class='tabledata ".$BCS_TX_select."' data-type='select' data-pk='".$res1['RAFID'][$i]."'>".$res1['BCS_TX_INP'][$i]."</span> ".$BCS_TX_INP_info."</td>";
                }
                if ($bcs_net1!="NA"){
                ...
                if ($res1['PARTNER_ACQUIRED'][$i]!="NA"){
                $$output_raf.="<td class='".$PARTNER_ACQUIRED_class." '><div id='PARTNER_ACQUIRED-".$res1['RAFID'][$i]."' class='tabledata ".$partneracq_select."' data-pk='".$res1['RAFID'][$i]."'>".$res1['PARTNER_ACQUIRED'][$i]."</div></td>";                
                }
                 if ($res1['TXMN_ACQUIRED'][$i]!="NA"){
                $$output_raf.="<td class='".$TXMN_ACQUIRED_class." '><div id='TXMN_ACQUIRED-".$res1['RAFID'][$i]."' class='tabledata ".$txmnacq_select."'  data-pk='".$res1['RAFID'][$i]."'>".$res1['TXMN_ACQUIRED'][$i]."</div></td>";
                }
                if ($res1['NET1_ACQUIRED'][$i]!="NA"){
                $$output_raf.="<td class='".$NET1_ACQUIRED_class." '><div id='NET1_ACQUIRED-".$res1['RAFID'][$i]."' class='tabledata ".$net1acq_select."' data-pk='".$res1['RAFID'][$i]."'>".$res1['NET1_ACQUIRED'][$i]."</div></td>";
                }
                $$output_raf.="<td class='".$RADIO_FUND_class."'><div id='RADIO_FUND-".$res1['RAFID'][$i]."' class='tabledata ".$FUNDSTATUS_select."' data-pk='".$res1['RAFID'][$i]."' data-value='".$res1['RADIO_FUND'][$i]."'>".$RADIO_FUND."</div> ".$RADIO_FUND_info."</td>";
...
?>
<button class="btn btn-xs btn-default rafnav pull-right" <?=$disable_raf_creation?> href='scripts/raf/raf_details_other.php' data-siteid='<?=$_POST['siteID']?>' data-action='newraf'><span class="glyphicon glyphicon-plus-sign"></span> Add new RAF</button>
<?php }
if ($_POST['siteID'] or $_POST['rafid']) { 
?>
<button class="btn btn-xs btn-default rafnav pull-right"  title='Show deleted and As Build' href='scripts/raf/raf_details_other.php'  data-action='showhidedeleted'><span class="glyphicon glyphicon-eye-open"></span> <?=$asbuildDelRAF?></button>
<?php } ?>
<br><br>
<div class="row">
  <div class="col-md-5" style="background-color: #FFFFFF;"><?=$out_normal2?><?=$out_asbuild2?><?=$out_deleted2?></div>
  <div class="col-md-7" style="overflow: auto;background-color: #eeFFFF;min-height: 300px;"><?=$out_normal?><?=$out_asbuild?><?=$out_deleted?></div>
</div>
