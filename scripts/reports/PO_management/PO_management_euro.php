...
include("Euro_total.php");
include("Euro_material.php");
include("Euro_txmn.php");
include("Euro_services.php");

$title = new title('Total Euro per month');
...
$data_euro= $chart->toPrettyString();
