...
include("Lead_total.php");
include("Lead_material.php");
include("Lead_txmn.php");
include("Lead_services.php");

$title = new title('Average of leadtime per month');
...
$bar1 = new bar_3d();
$bar1->colour( '#3399FF');
$bar1->set_tooltip( 'Total:<br>#val#' );
$bar1->key('Total average per month', 12);
...
$data_leadtime= $chart->toPrettyString();
