...
//include("Euro_ericsson_total.php");
include("Euro_material_ericsson.php");
//include("Euro_ericsson_txmn.php");
//include("Euro_ericsson_services.php");

$title = new title('Total Euro HARDWARE per month for Ericsson');
...
$data_euro_ericsson= $chart->toPrettyString();
