...
}else if (trim($type)=="LTE1800" or trim($type)=="LTE800" or trim($type)=="LTE2600"){
	if (trim($type)=="LTE1800"){
		$lognode=$_POST['lognodeID_LTE1800'];
	}else if (trim($type)=="LTE800"){
		$lognode=$_POST['lognodeID_LTE800'];
	}else if (trim($type)=="LTE2600"){
...
}else if (trim($type)=="UMTS900" or trim($type)=="UMTS2100"){
	if (trim($type)=="UMTS900"){
		$lognode=$_POST['lognodeID_UMTS900'];

	}else if (trim($type)=="UMTS2100"){
