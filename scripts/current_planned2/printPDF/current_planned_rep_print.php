...
include("current_planned_rep_output.php");
$pl_COMMENTS="";
/******************************************************************** UMTS */
$type="UMTS";
...
$check_current_exists=check_current_exists($type,'allsec');

if ($check_current_exists!=0 || $BSDS_status=="BSDS FUNDED"){
	$check_planned_exists=check_planned_exists("UMTS",'allsec');
}
...
<u><b>UMTS:</b></u><br> <? echo $pl_COMMENTS ?><br>
<u><b>UMTS900:</b></u><br> <? echo $pl_COMMENTS ?><br>
</div>
<?
