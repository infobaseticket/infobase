...
if($band=="G9" || $band=="G18"){
	...
	if ($check_planned_exists!="0" && $_POST['reloadAsset']!='yes'){  			//IF PLANNED DATA HAS ALREADY BEEN SAVED
		...
		if ($band=="G9"){
			...
			$pl_FEEDERSHARE_5=$planneddata_feedershare['GSM900_5'][0];
			$pl_FEEDERSHARE_6=$planneddata_feedershare['GSM900_6'][0];
		}
		if ($band=="G18"){
			...
			$pl_FEEDERSHARE_5=$planneddata_feedershare['GSM1800_5'][0];
			$pl_FEEDERSHARE_6=$planneddata_feedershare['GSM1800_6'][0];
		}
	...
	if ($check_planned_exists_UMTS!="0" && $_POST['reloadAsset']!='yes'){
