...
if ($_POST['lognode']!="" && $_POST['bsdskey']!=""){
	...
	if ($_POST['onlyfeeder']!="yes"){ //We don't save current when only feeder data is updated/inserted
		...
		if ($check_current_exists_UMTS=="0"){
			...
			$query1 = "INSERT INTO BSDS_CU_".$tabletype."2 VALUES ('','".$_POST['lognode']."','','',
			...
			'".$_POST['band']."','PRE',";
			if ($_POST['band']=="L18" or $_POST['band']=="L26" or $_POST['band']=="L8"){
				$query1 .= "'".$_POST['BPL']."','".$_POST['BPC']."','".$_POST['BPK']."','".$_POST['CC']."','".$_POST['BPN2']."','".$_POST['PM0']."','".$_POST['FS5']."','".$_POST['RECT']."')";
			}else if ($_POST['band']=="U21" or $_POST['band']=="U9"){
				$query1 .= "'".$_POST['BPC']."','".$_POST['BPK']."','".$_POST['CC']."','".$_POST['BPN2']."','".$_POST['PM0']."','".$_POST['FS5']."','".$_POST['RECT']."','".$_POST['BPL']."')";
			}
			$action="saved";
		}else{
			$query1 = "UPDATE BSDS_CU_".$tabletype."2 SET
				...
				if ($_POST['band']=="L18" or $_POST['band']=="L26" or $_POST['band']=="L8"){
					$query1 .= "BPL='".$_POST['BPL']."',BPC='".$_POST['BPC']."',BPK='".$_POST['BPK']."',CC='".$_POST['CC']."',BPN2='".$_POST['BPN2']."',PM0='".$_POST['PM0']."',FS5='".$_POST['FS5']."',RECT='".$_POST['RECT']."',";
				}else if ($_POST['band']=="U21" or $_POST['band']=="U9"){
					$query1 .= "BPC='".$_POST['BPC']."',BPK='".$_POST['BPK']."',CC='".$_POST['CC']."',BPN2='".$_POST['BPN2']."',PM0='".$_POST['PM0']."',FS5='".$_POST['FS5']."',RECT='".$_POST['RECT']."',";
				}
				$query1 .= "CHANGE_DATE = SYSDATE
		...
		for ($n = 1; $n <= 6; $n++) {
			...
			//echo $check_current_exists_UMTS_sec;
			if($check_current_exists_UMTS_sec=="0"){
				$query2 = "INSERT INTO BSDS_CU_".$tabletype."_SEC2 VALUES ('".$_POST['bsdskey']."','".$_POST['lognode']."','".$_POST['UMTSCELLID_'.$n]."','".$_POST['UMTSCELLPK_'.$n]."',
				'".$_POST['band']."','".$n."','PRE',SYSDATE,'',
				...
				'".$_POST['AZI1_'.$n]."','".$_POST['AZI2_'.$n]."','".$_POST['FEEDER_'.$n]."','".$_POST['FEEDERLEN_'.$n]."','".$_POST['FREQ_ACTIVE_'.$n]."')";
				$action="saved";
			}else if($check_current_exists_UMTS_sec=="1"){
				$query2 = "UPDATE BSDS_CU_".$tabletype."_SEC2 SET
