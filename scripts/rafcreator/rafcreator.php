...
$(document).ready( function(){
  ...
  $('#inputRADIO_FUND').val('NA').attr('readonly', true).disableOptions(true);
  ...
  $('#inputRF_PAC').val('NA').attr('readonly', true).disableOptions(true);
	...
	$("#buffer").change(function(){
      ...
      $('#inputACQ_PARTNER').val('NA').attr('readonly', true).disableOptions(true);
      $('#inputPOACQ').val('OK').attr('readonly', true).disableOptions(true);
      ...
      $('#inputTXMN_LOS').val('OK').attr('readonly', true).disableOptions(true);
      ...
      if ($("#inputTYPE").val().indexOf("MSH Upgrade")!=-1){
        ...
        $('#inputACQ_PARTNER').val('NA').attr('readonly', true).disableOptions(true);
        $('#inputPOACQ').val('NA').attr('readonly', true).disableOptions(true);
        $('#inputPARTNER').val('NA').attr('readonly', true).disableOptions(true); //ALU_INP
        $('#inputBCS_STATUS').val('NA').attr('readonly', true).disableOptions(true);
        $('#inputTXMN_LOS').val('NA').attr('readonly', true).disableOptions(true);
      ...
      $('#inputACQ_PARTNER').val('TECHM').attr('readonly', false).disableOptions(false);
      $('#inputPOACQ').val('NOT OK').attr('readonly', false).disableOptions(false);
      ...
      $('#inputTXMN_LOS').val('NOT OK').attr('readonly', false).disableOptions(false);
          ...
          <div class="form-group">
            ...
            <div class="col-sm-7">
              <select name="RAFTYPE" class="form-control input-sm" id="inputTYPE">
                ...
                <?php 
                $query = "select DISTINCT(TYPE) from BSDS_RAFV2 WHERE TYPE IS NOT NULL AND TYPE!='Dismantling' ORDER BY TYPE";
      ...
      <div class="col-md-4">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <div class="form-group">
              <label for="inputACQ_PARTNER" class="col-sm-5 control-label">SAC PARTNER</label>
              <div class="col-sm-7">
                <select name="ACQ_PARTNER" class="form-control input-sm" id="inputACQ_PARTNER">
                  <option>NOT OK</option><option>TECHM</option><option>BENCHMARK</option><option>ZTE</option><option>ALU</option><option>NA</option></select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <select name="PARTNER_INP" class="form-control input-sm" id="inputPARTNER">
                  <option>NOT OK</option><option>OK</option><option>NA</option></select>
              </div>
            </div>

            <div class="form-group">
              <label for="inputBCS_STATUS" class="col-sm-5 control-label">BCS NET1</label>
              <div class="col-sm-7">
                <select name="BCS_NET1" class="form-control input-sm" id="inputBCS_STATUS">
                  <option>NOT OK</option><option>OK</option><option>NA</option></select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <select name="PARTNER_ACQUIRED" class="form-control input-sm" id="inputPARTNER_ACQUIRED">
                  <option>NOT OK</option><option>OK</option><option>NA</option></select>
              </div>
            </div>
            ...
            <div class="form-group">
              <label for="inputNET1_ACQUIRED" class="col-sm-5 control-label">NET1 ACQUIRED</label>
              <div class="col-sm-7">
            ...
            <div class="form-group" id="inputRF_FUND2">
              ...
              <div class="col-sm-7">
                <input type='text' name="RADIO_FUND" class="form-control input-sm" id="inputRF_FUNDB" value="MSH">
              </div>
            </div>
              ...
              <div class="col-sm-7">
                <div class="row">
                  <div class="col-md-4">
                    <div class="checkbox">
                    <label>
                      <input type="checkbox" name="RADIO_FUND_G9" value="G9"> G9
                    </label>
                    </div>
                    <div class="checkbox">
                    <label>
                      <input type="checkbox" name="RADIO_FUND_G18" value="G18"> G18
                    </label>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="checkbox">
                    <label>
                      <input type="checkbox" name="RADIO_FUND_U9" value="U9"> U9
                    </label>
                    </div>
                    <div class="checkbox">
                    <label>
                      <input type="checkbox" name="RADIO_FUND_U21" value="U21"> U21
                    </label>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="checkbox">
                    <label>
                      <input type="checkbox" name="RADIO_FUND_L8" value="L8"> L8
                    </label>
                    </div>
                    <div class="checkbox">
                    <label>
                      <input type="checkbox" name="RADIO_FUND_L18" value="L18"> L18
                    </label>
                    </div>
                    <div class="checkbox">
                    <label>
                      <input type="checkbox" name="RADIO_FUND_L26" value="L26"> L26
                    </label>
                    </div>
                  </div>
                </div>
            ...
            <div class="form-group">
              <label for="inputCON_PARTNER" class="col-sm-5 control-label">CON PARTNER</label>
              <div class="col-sm-7">
                <select name="CON_PARTNER" class="form-control input-sm" id="inputCON_PARTNER">
                  <option>NOT OK</option><option>TECHM</option><option>BENCHMARK</option><option>ZTE</option><option>ALU</option></select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <select name="PARTNER_PAC" class="form-control input-sm" id="inputPACSTATUS">
          ...
          <div class="panel panel-default">
            ...
            <div id="SiteData" class="panel-collapse collapse in">
              <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <textarea class="form-control input-sm" name="RFPLAN" id="RFPLAN"></textarea>
                  </div>
              </div>
